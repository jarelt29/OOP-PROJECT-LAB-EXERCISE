...
public class ArithmeticGame extends JFrame implements ActionL3istener {
    ...
    public ArithmeticGame() {
        ...
        Color panelColor = new Color(220, 230, 250);
        ...
        titleLabel.setForeground(new Color(50, 60, 160));
        ...
        operatorLabel.setFont(new Font("Segoe UI", Font.BOLD, 36));
        ...
        equalLabel.setFont(new Font("Segoe UI", Font.BOLD, 36));
        equalLabel.setForeground(Color.RED);
        gbc.gridx = 3;
        problemPanel.add(equalLabel, gbc);

        answerField = new JTextField(6);
        answerField.setFont(new Font("Segoe UI", Font.BOLD, 30));
        ...
        JPanel levelOpPanel = new JPanel(new BorderLayout(10, 10));
        ...
        subBox = new JCheckBox("-", true);
        mulBox = new JCheckBox("*", true);
        ...
        levelOpPanel.setLayout(new GridLayout(1, 2, 10, 10));
        ...
        correctScoreLabel.setFont(new Font("Segoe UI", Font.BOLD, 16));
        incorrectScoreLabel.setFont(new Font("Segoe UI", Font.BOLD, 16));
    ...
    private JLabel makeNumberLabel(String text) {
        ...
        label.setBorder(BorderFactory.createLineBorder(new Color(100, 100, 200), 3));
        return label;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (src == submitButton) {
            checkAnswer();
        } else if (src == level1Radio) {
            setLevel(1, 50);
        } else if (src == level2Radio) {
            setLevel(51, 100);
        } else if (src == level3Radio) {
            setLevel(101, 300);
        }
    }
